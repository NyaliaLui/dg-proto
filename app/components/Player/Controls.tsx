  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseDown={() => { updateKey('q', true); updateKey('ctrl', true); }}
        onMouseUp={() => { updateKey('q', false); updateKey('ctrl', false); }}
        onMouseLeave={() => { updateKey('q', false); updateKey('ctrl', false); }}
        onTouchStart={() => { updateKey('q', true); updateKey('ctrl', true); }}
        onTouchEnd={() => { updateKey('q', false); updateKey('ctrl', false); }}
      >
        <span className="block leading-tight text-center">Crouch<br/>Atk</span>
      </button>
