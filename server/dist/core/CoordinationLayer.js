...
exports.CoordinationLayer = void 0;
class CoordinationLayer {
   ...
   */
  getFlankTargetX(barb, player, worldBounds) {
    // If player faces +X (right), blind side is −X (left), and vice versa.
    const blindSide = -player.facingDirection;
   ...
   */
  getFlankDirection(barb, flankTargetX) {
