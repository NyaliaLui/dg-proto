...
class GameStateManager {
  constructor() {
    this.current = null;
    this.history = [];
    this.squadStrategy = 'COORDINATED';
    this.claudeInsights = null;
  ...
  enrich(msg) {
    ...
    const barbarians = msg.barbarians.map((raw) =>
 ...
 */
function xzAngleToTarget(from, facingDir, to) {
 ...
 */
function isWithinFOV(barbPos, player) {
